...
## [2.2.0] - 2025-09-08
### Changed
- `options.debugDisplay` converted from a Bool to a String to allow for options `Off`, `Simple` and `Advanced`.

## [2.1.1] - 2025-06-28
### Changed
- Renamed `options.inputOffset` to `options.globalOffset`.
