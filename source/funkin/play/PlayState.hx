...
class PlayState extends MusicBeatSubState
{
  ...
  **/
  ...
  public function new(?params:PlayStateParams)
  {
    ...
    var noteStyleId:String = currentChart?.noteStyle ?? Constants.DEFAULT_NOTE_STYLE;
    @:nullSafety(Off) // We already fallback to the default note style above so no worries about null here
